...
{
    public class GetPayTypeDetailModel
    {
        ...
        public static Expression<Func<PayType, string, GetPayTypeDetailModel>> Projection
        {
            get
            {
                Localization localize = new();
                return (tr, language) => new GetPayTypeDetailModel
                {
                    Id = tr.ID,

...
{
    public class CreateValidator : AbstractValidator<CreatePayTypeCommand>
    {
        public CreateValidator(IStringLocalizer<CommonValidationResource> localizer, IGeneralHelperRepositoryAsync<ERP_DbContext, PayType> helper)
        {

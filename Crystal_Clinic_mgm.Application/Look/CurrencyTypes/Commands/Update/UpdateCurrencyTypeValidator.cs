...
{
    public class UpdateCurrencyTypeValidator : AbstractValidator<UpdateCurrencyTypeCommand>
    {
        public UpdateCurrencyTypeValidator(IStringLocalizer<CommonValidationResource> localizer, IGeneralHelperRepositoryAsync<ERP_DbContext, CurrencyType> helper)
        {

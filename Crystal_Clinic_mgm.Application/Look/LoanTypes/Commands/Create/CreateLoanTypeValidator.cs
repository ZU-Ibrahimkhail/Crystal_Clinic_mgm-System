...
{
    public class CreateValidator : AbstractValidator<CreateLoanTypeCommand>
    {
        public CreateValidator(IStringLocalizer<CommonValidationResource> localizer, IGeneralHelperRepositoryAsync<ERP_DbContext, LoanType> helper)
        {

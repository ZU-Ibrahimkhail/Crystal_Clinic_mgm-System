...
{
    public class DeleteLoanTypeHandler(
        IGenericRepositoryAsync<ERP_DbContext, LoanType> genericRepositoryAsync,
        IMessage message,
        ILoggedInUser loggedInUser) : IRequestHandler<DeleteLoanTypeCommand, JsonResult>
    {
        ...
        public async Task<JsonResult> Handle(DeleteLoanTypeCommand request, CancellationToken cancellationToken)
        {

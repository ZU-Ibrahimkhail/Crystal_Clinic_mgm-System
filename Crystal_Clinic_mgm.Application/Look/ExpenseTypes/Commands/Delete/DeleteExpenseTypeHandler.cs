...
{
    public class DeleteExpenseTypeHandler(
        IGenericRepositoryAsync<ERP_DbContext, ExpenseType> genericRepositoryAsync,
        IMessage message,
        ILoggedInUser loggedInUser) : IRequestHandler<DeleteExpenseTypeCommand, JsonResult>
    {
        ...
        public async Task<JsonResult> Handle(DeleteExpenseTypeCommand request, CancellationToken cancellationToken)
        {

...
{
    public class CreateValidator : AbstractValidator<CreateExpenseTypeCommand>
    {
        public CreateValidator(IStringLocalizer<CommonValidationResource> localizer, IGeneralHelperRepositoryAsync<ERP_DbContext, ExpenseType> helper)
        {

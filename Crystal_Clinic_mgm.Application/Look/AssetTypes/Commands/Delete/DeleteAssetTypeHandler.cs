...
{
    public class DeleteAssetTypeHandler(
        IGenericRepositoryAsync<ERP_DbContext, AssetType> genericRepositoryAsync,
        IMessage message,
        ILoggedInUser loggedInUser) : IRequestHandler<DeleteAssetTypeCommand, JsonResult>
    {
        ...
        public async Task<JsonResult> Handle(DeleteAssetTypeCommand request, CancellationToken cancellationToken)
        {

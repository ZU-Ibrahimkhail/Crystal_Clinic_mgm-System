...
{
    public class CreateValidator : AbstractValidator<CreateAssetTypeCommand>
    {
        public CreateValidator(IStringLocalizer<CommonValidationResource> localizer, IGeneralHelperRepositoryAsync<ERP_DbContext, AssetType> helper)
        {

...
{
    public class GetAssetTypeDetailModel
    {
        ...
        public static Expression<Func<AssetType, string, GetAssetTypeDetailModel>> Projection
        {
            get
            {
                Localization localize = new();
                return (tr, language) => new GetAssetTypeDetailModel
                {
                    Id = tr.ID,

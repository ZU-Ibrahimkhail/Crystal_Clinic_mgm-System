...
{
    public class UpdateContractDetailsValidator : AbstractValidator<UpdateContractDetailsCommand>
    {
        public UpdateContractDetailsValidator(IStringLocalizer<CommonValidationResource> localizer, IStringLocalizer<CommonColumnNameResource> columnLocalizer)
        {

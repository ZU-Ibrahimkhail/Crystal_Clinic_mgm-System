...
{
    public class DeletePartnersHandler(
        IGenericRepositoryAsync<ERP_DbContext, Partners> genericRepositoryAsync,
        IMessage message,
        ILoggedInUser loggedInUser) : IRequestHandler<DeletePartnersCommand, JsonResult>
    {
        ...
        public async Task<JsonResult> Handle(DeletePartnersCommand request, CancellationToken cancellationToken)
        {

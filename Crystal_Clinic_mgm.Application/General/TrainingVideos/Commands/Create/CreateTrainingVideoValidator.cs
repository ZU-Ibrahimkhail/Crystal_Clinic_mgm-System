...
{
    public class CreateTrainingVideoValidator : AbstractValidator<CreateTrainingVideoCommand>
    {
        public CreateTrainingVideoValidator(IStringLocalizer<CommonValidationResource> localizer, IStringLocalizer<CommonColumnNameResource> columnLocalizer)
        {

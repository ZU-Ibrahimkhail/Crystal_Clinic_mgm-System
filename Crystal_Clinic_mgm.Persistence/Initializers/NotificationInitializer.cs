        ...
        public static async Task SeedNotificationMessages(UMS_DbContext context)
        {
            ...
            if (Roles.Count == 14)
            {
                try
                {
                    ...
                    {
                        EnglishTitle = "New Service Session",
                        EnglishMessage = "There is a new session to be implemented!",
                        ApplicationName = "CrystalClinic",
                        EnglishDescription = "This message is created informing the client user that There is a new session to be implemented.",

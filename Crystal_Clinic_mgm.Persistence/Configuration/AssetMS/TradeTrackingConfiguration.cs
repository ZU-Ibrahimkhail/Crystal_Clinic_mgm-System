...
{
    public class TradeTrackingConfiguration : IEntityTypeConfiguration<TradeTracking>
    {
        public void Configure(EntityTypeBuilder<TradeTracking> entity)
        {
            entity.ToTable(nameof(TradeTracking), "AssetMS");
            entity.HasKey("ID");
            ...
            entity.Property(c => c.TradeAmount).HasColumnName("TradeAmount").HasColumnType("real").IsRequired(true);
            entity.Property(c => c.ProfitAmount).HasColumnName("ProfitAmount").HasColumnType("real").IsRequired(true);
            entity.Property(c => c.LossAmount).HasColumnName("LossAmount").HasColumnType("real").IsRequired(true);


            EntityConfiguration<TradeTracking>.AuditableEntityConfigurations(entity);

...
namespace Crystal_Clinic_Mgm.Common.CustomMiddlewere
{
    public class ErrorHandlerMiddlewere : ExceptionFilterAttribute
    {
        private readonly IDictionary<Type, Action<ExceptionContext>> _exceptionHandlers;
        public ErrorHandlerMiddlewere()
        {
            ...
            _exceptionHandlers = new Dictionary<Type, Action<ExceptionContext>>
            {
              ...
              { typeof(HandleSQLException), HandleSqlException },
            };
        }
        ...
        private void HandleUnknownException(ExceptionContext context)
        {
            ...
            var details = new ProblemDetails
            {
                ...
                Title = context.Exception.Message.Replace("\r\n", string.Empty),
